...
res_l = create_zip_layer('large_layers')
res_s = create_zip_layer('small_layers')
res_u = create_zip_layer('extract_layer')

upload_zip_to_s3(res_l,'libraries-layer-aci',"large_libraries.zip")
upload_zip_to_s3(res_s,'libraries-layer-aci',"small_libraries.zip")
