...
#   bucket = var.lambda_code_bucket_name
#   key    = "python/utils/connection.py"
#   source = "../extract_layer/utils/python/connection.py"

#   etag = filemd5("../extract_layer/utils/python/connection.py")
# }

# resource "aws_s3_object" "db_credentials_object" {
#   bucket = var.lambda_code_bucket_name
#   key    = "python/utils/db_credentals.py"
#   source = "../extract_layer/utils/python/db_credentials.py"

#   etag = filemd5("../extract_layer/utils/python/db_credentials.py")
# }

# resource "aws_s3_object" "extraction_info_object" {
#   bucket = var.lambda_code_bucket_name
#   key    = "python/utils/extraction_info.py"
#   source = "../extract_layer/utils/python/extraction_info.py"

#   etag = filemd5("../extract_layer/utils/python/extraction_info.py")
# }

# resource "aws_s3_object" "save_data_object" {
#   bucket = var.lambda_code_bucket_name
#   key    = "python/utils/save_data.py"
#   source = "../extract_layer/utils/python/save_data.py"

#   etag = filemd5("../extract_layer/utils/python/save_data.py")
# }
